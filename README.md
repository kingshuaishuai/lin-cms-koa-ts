...
lin-cms-koa-ts(当前示例工程)：0.0.1

[@ysslin/alioth(核心库)](https://www.npmjs.com/package/@ysslin/alioth) ：0.0.1
...
1. `C` 创建基于`@ysslin/alioth`的基础库，创建TS版本的koa-cms,升级了sequelize等基础库,修复了一些bug
