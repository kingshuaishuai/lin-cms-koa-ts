import { LinValidator, Rule } from '@ysslin/alioth'

export class BookSearchValidator extends LinValidator {
  constructor () {
    super()
...
export class CreateOrUpdateBookValidator extends LinValidator {
  constructor () {
    super()
